...
Read-only audit of the official Project B starter, folder boundaries, placeholders, required artifacts and check_handin baseline.
...
17 checks passed after replacing agent placeholders; report and result reminders remained expected.
