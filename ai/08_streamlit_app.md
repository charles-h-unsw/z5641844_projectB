...
Built the six-section Signal Mosaic investor journey using only precomputed results, plus allocation logic, static deployment checks and a headless smoke test.
...
The app does not load raw data, run NLTK, rebuild portfolios or write analytical files.
