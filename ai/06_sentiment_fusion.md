...
Implemented a pre-specified alpha=0.15 Naive Sentiment Tilt and a continuous Coverage-Gated Sentiment Tilt on the Equity Equal Weight base.
...
Both tilts underperformed Equal Weight on return and Sharpe; Coverage-Gated reduced part of the Naive Tilt shortfall. Parameters were not retuned.
