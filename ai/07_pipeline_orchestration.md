...
Made Project B self-contained, removed the one-time Project A runtime reconciliation dependency and created the deterministic run_part_b stage order.
...
Two complete runs produced matching deterministic CSV hashes; 81 validation rows passed.
