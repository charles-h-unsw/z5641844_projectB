...
Corrected the compact date range, investor-facing table labels, percentage formatting, duplicated copy and other display-only issues.
...
Analytical CSV hashes were unchanged and the app smoke test passed.
